 ...
 * Proxies multipart image uploads to the backend upload endpoint.
 * Returns { urls: string[] } with server-relative paths (/uploads/products/…).
 */
export async function POST(request: Request) {
  ...
  let res: Response
  try {
    res = await fetch(`${API_BASE}/api/admin/products/images`, {
      method: "POST",
